...
public interface CartItemRepository extends JpaRepository<CartItemEntity, Integer> {
	...
	CartItemEntity findByCartIdAndProductIdAndHotnessLevel(@Param ("cartId") Integer cartId,@Param ("productId") Integer productId,@Param ("hotnessLevel") String hotnessLevel);
